...
# Game is over. Tells whether students won or not.
if num_of_incorrect_guesses < 5:
  print("Congratulations. You solved the Hangman Puzzle")
else:
  print("Sorry, you have run out of guesses.")

print(f"{answer_characters} is the answer of the puzzle.")
